...
namespace DMP_Brake_Press_Application
{
    public partial class Check_Card_Data_Viewer : Form
    {
        ...
        ********************************************************************************************************************/
        ...
        private void CheckCardData_GridView_CellClick(object sender, DataGridViewCellEventArgs e)
        {
            if (e.RowIndex >= 0)
            {
                DataGridViewRow Row = CheckCardData_GridView.Rows[e.RowIndex];
        ...
        private void CheckCardData_GridView_DataError(object sender, DataGridViewDataErrorEventArgs e)
        {
            e.Cancel = true;
        }
        ...
        ********************************************************************************************************************/
        ...
        private void SearchCommand_SQL()
        {
            ...
            {
                SearchCommand = "SELECT Date, Time, GageNumber, BaleNumber, LotNumber, EmployeeDMPID, CodeNumber, BuddyCheckDMPID, Check_A, Check_B, Check_C, Check_D, Check_E, Check_F, Check_G, Check_H, Check_I, ItemID, Sequence, Customer, CustomerPartID, EmployeeName, BuddyCheckName FROM [dbo].[CheckCardData_BrakePress] WHERE ItemID ='" + ItemIDSearch_TextBox.Text + "' AND Date BETWEEN '" + DateStartPicker.Value.Date.ToShortDateString() + "' AND '" + DateEndPicker.Value.Date.ToShortDateString() + "' ORDER BY CheckCountTotal ASC";
            ...
            {
                SearchCommand = "SELECT Date, Time, GageNumber, BaleNumber, LotNumber, EmployeeDMPID, CodeNumber, BuddyCheckDMPID, Check_A, Check_B, Check_C, Check_D, Check_E, Check_F, Check_G, Check_H, Check_I, ItemID, Sequence, Customer, CustomerPartID, EmployeeName, BuddyCheckName FROM [dbo].[CheckCardData_BrakePress] WHERE ItemID ='" + ItemIDSearch_TextBox.Text + "'" + " ORDER BY CheckCountTotal ASC";
            ...
            {
                SearchCommand = "SELECT Date, Time, GageNumber, BaleNumber, LotNumber, EmployeeDMPID, CodeNumber, BuddyCheckDMPID, Check_A, Check_B, Check_C, Check_D, Check_E, Check_F, Check_G, Check_H, Check_I, ItemID, Sequence, Customer, CustomerPartID, EmployeeName, BuddyCheckName FROM [dbo].[CheckCardData_BrakePress] WHERE Date BETWEEN '" + DateStartPicker.Value.Date.ToShortDateString() + "' AND '" + DateEndPicker.Value.Date.ToShortDateString() + "' ORDER BY CheckCountTotal ASC";
                //SearchCommand = "SELECT * FROM [dbo].[CheckCardData_BrakePress] WHERE CustomerItemNumber ='" + CustomerItemNumberSearch_TextBox.Text + "'" + " ORDER BY CheckCountTotal DESC";
        ...
        private void CheckCard_TotalCount()
        {
            if (ItemID_CheckBox.Checked == true && CustomerItemNumber_CheckBox.Checked == false && DateStartPicker.Checked == true)
            {
                RowCountString = "SELECT COUNT(*) FROM [dbo].[CheckCardData_BrakePress] WHERE ItemID='" + ItemIDSearch_TextBox.Text + "' AND Date BETWEEN '" + DateStartPicker.Value.Date.ToShortDateString() + "' AND '" + DateEndPicker.Value.Date.ToShortDateString() + "'";
            }
            if (ItemID_CheckBox.Checked == false && CustomerItemNumber_CheckBox.Checked == true && DateStartPicker.Checked == true)
            {
                RowCountString = "SELECT COUNT(*) FROM [dbo].[CheckCardData_BrakePress] WHERE CustomerPartID='" + CustomerItemNumberSearch_TextBox.Text + "' AND Date BETWEEN '" + DateStartPicker.Value.Date.ToShortDateString() + "' AND '" + DateEndPicker.Value.Date.ToShortDateString() + "'";
            }
            if (ItemID_CheckBox.Checked == true && CustomerItemNumber_CheckBox.Checked == false && DateStartPicker.Checked == false)
            {
                RowCountString = "SELECT COUNT(*) FROM [dbo].[CheckCardData_BrakePress] WHERE ItemID='" + ItemIDSearch_TextBox.Text + "'";
            }
            if (ItemID_CheckBox.Checked == false && CustomerItemNumber_CheckBox.Checked == true && DateStartPicker.Checked == false)
            {
                RowCountString = "SELECT COUNT(*) FROM [dbo].[CheckCardData_BrakePress] WHERE CustomerPartID='" + CustomerItemNumberSearch_TextBox.Text + "'";
            }
            try
            {
