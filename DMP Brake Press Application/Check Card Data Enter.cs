...
{
    public partial class Check_Card_Data_Enter : Form
    {
        public Check_Card_Data_Enter()
        {
            InitializeComponent();
        ...
        private void Check_Card_Data_Load(object sender, EventArgs e)
        {
            A_ComboBox.Items.AddRange(BoxAValues);
        ...
        private void Confirm_Button_Click(object sender, EventArgs e)
        {
            ...
            if (A_ComboBox.Text != "Pass" && A_ComboBox.Text != "Fail")
            {
                MessageBox.Show("Please Select a Value For Box A");
            }
            if (GageNumber_TextBox.Text != "" && BaleNumber_TextBox.Text != "" && LotNumber_TextBox.Text != "" && OperatorID_TextBox.Text != "" && BuddyCheckID_TextBox.Text != "" && (A_ComboBox.Text == "Pass" || A_ComboBox.Text == "Fail") && B_TextBox.Text != "")
            {
                EmployeeIDSearch();
                BuddyCheckIDSearch();
                ...
                /*
                else if (OperatorNameFound == false && BuddyCheckNameFound == true)
                {
                    MessageBox.Show("Please Enter a Valid Operator ID #");
                }
                else if (OperatorNameFound ==true && BuddyCheckNameFound == false)
                {
                    MessageBox.Show("Please Enter a Valid Buddy Check ID #");
                }
                else if (OperatorNameFound == false && BuddyCheckNameFound == false)
                {
                    MessageBox.Show("Please Enter a Valid Operator ID # and a Valid Buddy Check ID #");
                }
                */
        ...
        private void CheckCard_ItemSearch()
        {
            try
            {
                string ItemIDCheckCount = "SELECT COUNT(ItemID) FROM [dbo].[CheckCardData_BrakePress] WHERE ItemID='" + ItemID_TextBox.Text + "' AND Sequence='" + Sequence_TextBox.Text + "'";
        ...
        private void CheckCard_TotalCount()
        {
            try
            { 
                string CheckCardCountString = "SELECT COUNT(*) FROM [dbo].[CheckCardData_BrakePress]";
        ...
        private void CheckCard_DataEntry()
        {
            try
            {
                ...
                CheckCardCommand.Parameters.AddWithValue("@Check_A", A_ComboBox.Text);
        ...
        private void BuddyCheckName_TextBox_Enter(object sender, EventArgs e)
        {
        ...
        private void CustomerPartNumber_TextBox_Enter(object sender, EventArgs e)
        {
            this.ActiveControl = null;
        }

        private void DateTime_TextBox_Enter(object sender, EventArgs e)
        {
            this.ActiveControl = null;
        }
        ...
        private void OperatorID_TextBox_Leave(object sender, EventArgs e)
        {
            EmployeeIDSearch();
        }

        private void BuddyCheckID_TextBox_Leave(object sender, EventArgs e)
        {
            BuddyCheckIDSearch();
        }
